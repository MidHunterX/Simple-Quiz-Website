(function(){
    ...
    app.controller('QuizController', ['$scope', '$http', '$sce', function ($scope, $http, $sce) {
        ...
        $scope.selectAnswer = function (qIndex, aIndex) {
            ...
            // note: if you add questions to the quiz in the future, you may need 
            // to display a fractional %, in which case you may use .toFixed(2)
            // on the calculation to call the JS function for fixed decimal
